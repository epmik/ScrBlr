...
{
    public class Tutorial14WindowExtented06 : IDisposable
    {
        ...
        public Tutorial14WindowExtented06(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings)
        {
            //ResourceDirectory = "opengl-tutorial.org/tutorial14_render_to_texture/";

            Resources = new Resources("opengl-tutorial.org/tutorial14_render_to_texture/");
            ...
            nativeWindowSettings = nativeWindowSettings != null ? nativeWindowSettings : new NativeWindowSettings()
            {
                ...
                Title = "Tutorial 14 - Render To Texture - Extented 6",
