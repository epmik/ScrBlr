...
namespace OpenGlTutorialOrg
{
    ...
    public class Tutorial08Window : AbstractTutorialWindow
    {
        int VertexArrayID;
        int programID;
        int vertexbuffer;
        ...
        public Tutorial08Window(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings)
            : base(gameWindowSettings, nativeWindowSettings)
        {
            Title = "Tutorial 08 - Basic Shading";
            ResourceDirectory = "opengl-tutorial.org/tutorial08_basic_shading/";
        }
