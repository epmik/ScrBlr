...
namespace OpenGlTutorialOrg
{
    ...
    public class Tutorial07Window : AbstractTutorialWindow
    {
        int VertexArrayID;
        int programID;
        int vertexbuffer;
        ...
        public Tutorial07Window(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings)
            : base(gameWindowSettings, nativeWindowSettings)
        {
            Title = "Tutorial 07 - Model Loading";
            ResourceDirectory = "opengl-tutorial.org/tutorial07_model_loading/";
        }
        ...
        protected override void OnLoad()
        {
            ...
            ObjLoader.Load(ResourcePath("cube.obj"), out var vertices, out var uvs, out var normals);
            ...
            GL.BufferData(BufferTarget.ArrayBuffer, uvs.Length * 2 * sizeof(float), uvs, BufferUsageHint.StaticDraw);
        }
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            GL.DrawArrays(OpenTK.Graphics.OpenGL4.PrimitiveType.Triangles, 0, vertexCount); // 3 indices starting at 0 -> 1 triangle
