...
namespace LearnOpenTK
{
    ...
    public class LearnOpenTK004 : GameWindow
    {
        ...
        public LearnOpenTK004(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings)
        ...
        protected override void OnLoad()
        {
            ...
            _shader = new Shader(".Shaders/LearnOpenTK004.vert", ".shaders/LearnOpenTK004.frag");
            _shader.Use();
        }
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            GL.DrawElements(PrimitiveType.Triangles, _indices.Length, DrawElementsType.UnsignedInt, 3);
