...
namespace LearnOpenTK
{
    ...
    public class LearnOpenTK009 : GameWindow
    {
        ...
        public LearnOpenTK009(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings)
        ...
        protected override void OnLoad()
        {
            ...
            _shader = new Shader(".shaders/LearnOpenTK009.vert", ".shaders/LearnOpenTK009.frag");
            _shader.Use();
        ...
        protected override void OnRenderFrame(FrameEventArgs e)
        {
            ...
            GL.DrawElements(PrimitiveType.Triangles, 3, DrawElementsType.UnsignedInt, 12);
