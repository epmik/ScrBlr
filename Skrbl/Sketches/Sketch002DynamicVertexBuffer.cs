...
namespace Skrbl
{
    public class Sketch002DynamicVertexBuffer : GameWindow
    {
        ...
        public Sketch002DynamicVertexBuffer(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings)
        ...
        protected override void OnLoad()
        {
            ...
            _shader = new(".shaders/orange.vert", ".shaders/orange.frag");
