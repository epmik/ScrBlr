namespace Scrblr.Rtx
{
    class Chapter064
    {
        ...
        {
            public abstract bool Hit(Ray r, double ray_tmin, double ray_tmax, HitRecord rec);
        }
        ...
        class Sphere : Hittable
        {
            ...
            public override bool Hit(Ray r, double ray_tmin, double ray_tmax, HitRecord rec)
            {
        ...
        static Vector3d RayColor(Ray r)
        {
            ...
            var hit = new Sphere(new Vector3d(0, 0, -1), 0.5).Hit(r, 0, double.PositiveInfinity, rec);
