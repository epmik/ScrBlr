...
{
    public abstract class AbstractSketch20220406 : ISketch
    {
        ...
        protected NearFarScrollCamera20220410 Camera = new NearFarScrollCamera20220410 { Near = 1f, Far = 10000f, Fov = 45f };
        ...
        public AbstractSketch20220406()
            : this(DefaultSketchWidth, DefaultSketchHeight)
        {

        }

        public AbstractSketch20220406(float sketchWidth, float sketchHeight)
        {
