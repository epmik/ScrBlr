...
namespace Scrblr.Core
{
    ...
    public class VertexBuffer20220413 : IDisposable
    {
        ...
        public VertexBufferLayout20220413 Layout { get; private set; }
        ...
        public VertexBuffer20220413(
            int elementCount,
            IEnumerable<VertexBufferLayout20220413.Part> parts,
            VertexBufferUsage vertexBufferType)
            : this(elementCount, new VertexBufferLayout20220413(parts), vertexBufferType) 
        {
        ...
        public VertexBuffer20220413(
            int elementCount,
            VertexBufferLayout20220413 layout,
        ...
        public void EnableElement(VertexBufferLayout20220413.PartIdentifier identifier)
        {
            GL.BindVertexArray(Layout.Handle);
        ...
        public void DisableElement(VertexBufferLayout20220413.PartIdentifier identifier)
        {
            GL.BindVertexArray(Layout.Handle);
