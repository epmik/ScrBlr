...
{
    [Sketch(Name = "Sketch004-device-coordinates-vertexbuffer-shader")]
...
";
        ...
        {
            -1.0f, -0.5f, 0.0f,      1.0f, 0.0f, 0.0f, 1.0f, // Bottom-left vertex
        ...
        public void Load()
        {
            ...
            _vertexBuffer.WriteRaw(_vertices);
        ...
        public void Render()
        {
            ...
            Graphics.Render(_vertexBuffer, _shader, GeometryType.LineLoop);
            ...
            //Graphics.Render(_vertexBuffer, _shader);
