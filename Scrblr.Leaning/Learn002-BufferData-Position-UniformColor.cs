...
{
    [Sketch(Name = "Learn001-BufferData-Position-UniformColor")]
    public class Learn002 : AbstractSketch20220317
    {
        public Learn002()
            : base(3, 3)
        {
...
void main()
{
    oColor = iColor;
        ...
        public void Render()
        {
            ...
            _shader.Uniform("iColor", 0.0f, 1.0f, 1.0f, 1.0f);

            //// This gets the uniform variable location from the frag shader so that we can 
            //// assign the new green value to it.
            //int vertexColorLocation = GL.GetUniformLocation(_shader.Handle, "iColor");
