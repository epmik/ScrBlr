...
namespace Scrblr.Learning
{
    ...
    public class Learn011Lighting : SilkSketch20240207
    {
...
";
        ...
        protected unsafe void OnLoad()
        {
            ...
            var export = ObjParser.Parse(".resources/cube-plane-monkey-camera-light.obj")
                .ExportScene(new ExportScene.Setting { Indexed = false, Flags = new List<ExportScene.Flag> { ExportScene.Flag.Vertices, ExportScene.Flag.Normals, ExportScene.Flag.Uv0 } });
