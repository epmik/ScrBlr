...
namespace Scrblr.Leaning
{
    ...
    public class Learn001A : AbstractSketch
    {
        ...
        public float SketchWidth { get; private set; } = 3;
        public float SketchHeight { get; private set; } = 3;
        ...
        private Matrix4x4 CreateProjectionMatrix()
        {
            ...
            //    (float)Utility.DegreesToRadians(ProjectionFov),
            //    window.Size.X / (float)window.Size.Y,
            //    ProjectionNear,
            //    ProjectionFar);

            return Matrix4x4.CreateOrthographic(SketchWidth, SketchHeight, ProjectionNear, ProjectionFar);
        }
        ...
        public unsafe void Load()
        {
            ...
            fixed (void* v = &_position[0])
                Gl.BufferData(GLEnum.ArrayBuffer, (nuint)(_position.Length * sizeof(float)), v, GLEnum.StaticDraw);
...
void main()
{
    oColor = vec4(1.0, 1.0, 0.0, 1.0);
        ...
        public void Render()
        {
            ...
            model = model * Matrix4x4.CreateTranslation(0.0f, 0.0f, -4.0f);
