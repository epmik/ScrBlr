...
namespace Scrblr.LearnOpenTK
{
    ...
    public class Learn010ObjParser : SilkSketch
    {
...
";
        ...
        public Learn010ObjParser()
        {
            ...
            var b1 = ObjParser.Parse(".resources/quad-001.obj");
            var b1v = b1.ExportScene(new ExportScene.Setting { Indexed = false, Flags = new List<ExportScene.Flag> { ExportScene.Flag.Vertices } });

            var b2 = ObjParser.Parse(".resources/cube-001.obj");
            var b2v = b2.ExportScene(new ExportScene.Setting { Indexed = false, Flags = new List<ExportScene.Flag> { ExportScene.Flag.Vertices } });

            var b3 = ObjParser.Parse(".resources/test-objects-001.obj");
            var b3v = b3.ExportScene(new ExportScene.Setting { Indexed = false, Flags = new List<ExportScene.Flag> { ExportScene.Flag.Vertices } });

            var b4 = ObjParser.Parse(".resources/test-objects-002.obj");
            var b4v = b4.ExportScene(new ExportScene.Setting { Indexed = false, Flags = new List<ExportScene.Flag> { ExportScene.Flag.Vertices } });
        }
        ...
        protected unsafe void OnLoad()
        {
            ...
            //var export = ObjFileReader.Parse(".resources/quad-001.obj").ExportVertices(false, ObjFileReader.ExportVerticesFlag.Vertices, ObjFileReader.ExportVerticesFlag.Uvs);
            //var export = ObjFileReader.Parse(".resources/cube-001.obj").ExportVertices(false, ObjFileReader.ExportVerticesFlag.Vertices, ObjFileReader.ExportVerticesFlag.Uvs);
            //var export = ObjFileReader.Parse(".resources/test-objects-001.obj").ExportVertices(false, ObjFileReader.ExportVerticesFlag.Vertices, ObjFileReader.ExportVerticesFlag.Uvs);
            var export = ObjParser.Parse(".resources/test-objects-002.obj").ExportScene(new ExportScene.Setting { Indexed = false, Flags = new List<ExportScene.Flag> { ExportScene.Flag.Vertices, ExportScene.Flag.Uv0 } });
