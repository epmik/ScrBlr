...
namespace Scrblr.LearnOpenTK
{
    ...
    public class Learn007 : GameWindow
    {
        ...
        public Learn007(GameWindowSettings gameWindowSettings, NativeWindowSettings nativeWindowSettings)
...
";
            ...
            _shader = new Shader(vertexShaderSource, fragmentShaderSource); _shader.Use();
